					 ...
					 struct drm_connector_state *conn_state)
{
	 ...
	 * color_space, so pin it to BT.709 for correct UHD colours.
	 *
	 * This sits above the rate/bpc early return on purpose: the output
	 * format can change while both stay the same (2160p30 4:4:4 and
	 * 2160p60 4:2:0 are both 297 MHz at 8 bpc), and returning early would
	 * leave the previous format in the duplicated CRTC state.
	 */
